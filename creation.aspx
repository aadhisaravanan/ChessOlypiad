...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <table class="center" background="/images/chessbackground.jpg" style="border: 0;" cellspacing="20px">
            <tr>
                <td>
                    <table class="center" style="background-color: #feeebd;" width="800px" style="border: 0;" cellpadding="5px">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="auto-style11" style="text-align: left">
                                <asp:DropDownList ID="DDL_HotelInspected" runat="server" Height="20px" Width="200px" ValidationGroup="cp">
                            ...
                            <td style="text-align: left">
                                <asp:DropDownList ID="DDL_Restaurants" runat="server" Height="20px" Width="200px"
                                    ValidationGroup="cp">
                                    <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td class="auto-style11" style="text-align: left">
                                <asp:DropDownList ID="DDL_Eateries" runat="server" Height="20px" Width="200px"
                                    ValidationGroup="cp">
                                    <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                            ...
                            <td style="text-align: left">
                                <asp:DropDownList ID="DDL_streetfood" runat="server" Height="20px" Width="200px" ValidationGroup="cp">
                                    <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:DropDownList ID="ddl_OtherFBOs" runat="server" Height="20px" Width="200px"
                                    ValidationGroup="cp">
                                    <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
            ...
            <tr>
                <td>
                    <table class="center" style="background-color: #70163C;" width="800px" style="border: 0;" cellspacing="5px">
                        <tr>
        ...
        <asp:Label ID="OpenDTM" runat="server"></asp:Label>
                            ...
                            <td class="auto-style5" style="text-align: left">
                                <asp:DropDownList ID="DDL_Fogging" runat="server" Height="20px" Width="200px"
                                    ValidationGroup="cp">
                                    <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                            ...
                            <td style="text-align: left">
                                <asp:DropDownList ID="DDL_Disinfection" runat="server" Height="20px" Width="200px"
                                    ValidationGroup="cp">
                                    <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                        ...
                        <tr>
                            ...
                            <td class="auto-style5" style="text-align: left">
                                <asp:DropDownList ID="DDL_Chlorination" runat="server" Height="20px" Width="200px"
                                    ValidationGroup="cp">
                                    <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                            ...
                            <td style="text-align: left">
                                <asp:DropDownList ID="DDL_Larvicidal" runat="server" Height="20px" Width="200px"
                                    ValidationGroup="cp">
                                    <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                    <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                    <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
                        ...
                        <tr>
                            <th colspan="2">
                                ...
                                <td style="text-align: left" class="auto-style5">
                                    <asp:DropDownList ID="ddl_kitchen" runat="server" Height="20px" Width="200px"
                                        ValidationGroup="cp">
                                        <asp:ListItem Text="-- Please Select --" Value="-- Please Select --"></asp:ListItem>
                                        <asp:ListItem Text="YES" Value="YES"></asp:ListItem>
                                        <asp:ListItem Text="NO" Value="NO"></asp:ListItem>
